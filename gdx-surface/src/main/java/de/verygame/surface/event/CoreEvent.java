...
import static de.verygame.surface.event.CoreEvent.Constants.*;
...
public enum CoreEvent implements Event {
     ...
     */
    SWITCH_SCREEN(SWITCH_SCREEN_ID, EventType.UI),
    /**
     * Indicates that a new language bundle has been loaded by the resource handler.
     * <br>
     * Attached Object: None
     */
    OPTION_CHANGED(OPTION_CHANGED_ID, EventType.RESOURCE),
    /**
     * Requests to hide the screen which emits this event.
     * <br>
     * Attached Object: None
     */
    HIDE_SCREEN(HIDE_SCREEN_ID, EventType.UI),
    /**
     * Requests a restart of the game.
     * <br>
     * attached Object: None
     */
    GAME_RESTART(GAME_RESTART_ID, EventType.GAME),
    GAME_PAUSE(GAME_PAUSE_ID, EventType.GAME),
    CALL_UI(CALL_UI_ID, EventType.UI);

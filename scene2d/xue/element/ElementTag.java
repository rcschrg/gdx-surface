...
public class ElementTag<T extends Actor> extends XueAbstractElementTag<T> {
    ...
    protected List<Attribute<? super T, ?>> defineAttributes() {
        return buildAttributeList(new de.verygame.square.core.scene2d.xue.element.attribute.AlphaAttribute(), new de.verygame.square.core.scene2d.xue.element.attribute.ColorAttribute(), new de.verygame.square.core.scene2d.xue.element.attribute.ActorAlignmentAttribute(), new de.verygame.square.core.scene2d.xue.element.attribute.SimpleGenericAttribute<Actor, Float>("x"),
                new de.verygame.square.core.scene2d.xue.element.attribute.SimpleGenericAttribute<Actor, Float>("y"), new de.verygame.square.core.scene2d.xue.element.attribute.SimpleGenericAttribute<Actor, Float>("width"), new de.verygame.square.core.scene2d.xue.element.attribute.SimpleGenericAttribute<Actor, Float>("height"));
    }
